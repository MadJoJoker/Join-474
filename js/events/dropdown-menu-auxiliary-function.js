...
export function initDropdowns(contactsData) {
    ...
    setupDocumentClickHandler(categoryDropdown, categoryOptions, assignedToDropdown, assignedToOptions);
    resetDropdownState();
}
 ...
 */
function setupDocumentClickHandler(categoryDropdown, categoryOptions, assignedToDropdown, assignedToOptions) {
    document.addEventListener("click", (event) => {
        ...
        if (assignedToDropdown && assignedToOptions) {
            handleOutsideClick(assignedToDropdown, assignedToOptions, closeAssignedToDropdown)(event);
        }
    });
}
