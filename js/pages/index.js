...
/**
 * onlick-function of "Login"-button. check input from email-field (validation)
...
/**
 * main function: process e-mail string, by comparing it to "users"-data in "fetchedData".
 * if not found: redirect unregistrated user to "signup".
 * else run input-validation by calling helper functions.
 * set sesstionStorage entries.
 * redirect user to "summary".
 * @param {string} userEmail - email adress
 */
...
/**
 * helper function for "processEmailString"; set initials for "header" to sessionStorage
...
/**
 * helper function for "processEmailString / initialsForHeader";
 * get initals from first and last part of user name 
...
/**
 * onclick-function of "signup" button. check wheter user is already registrated.
 * show message and redirect known user to "login", else process signup-data
 *  */
function checkUser() {
 ...
 * @param {string} mail - content of email-input field
 * @returns 
 */
...
/**
 * demo function for "handleLogin": add demo-user's data to "fetchedData"
 */
