    ...
    <div class="contact-details-header">
      ...
      <div class="contact-details-name-actions">
        ...
        <div class="contact-details-actions">
          <button class="contact-details-card-icon-button edit-button" data-id="${contact.id}">
          ...
          <button class="contact-details-card-icon-button delete-button" data-id="${contact.id}">
...
<div class="hide-on-desktop">
  ...
  <ul class="mobile-dropdown-menu">
    <li>
      <button class="mobile-dropdown-menu-button edit-button" data-id="${contact.id}">
      <svg viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg" class="icon-svg">
        <path
    ...
    <li>
      <button class="mobile-dropdown-menu-button delete-button" data-id="${contact.id}">
      <svg viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg" class="icon-svg">
        <path
