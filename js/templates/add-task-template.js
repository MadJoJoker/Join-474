        ...
        <div class="label-container">
            ...
            <div class="select-wrapper">
                ...
                <div id="subtask-icons" class="input-button" style="opacity: 0;">
                    <button type="button" class="subtask-action-btn" id="subtask-clear-btn" alt="Clear Subtask" data-event-handle="true">
                    ...
                    <button type="button" class="subtask-action-btn" id="subtask-add-task-btn" alt="Add Subtask" data-event-handle="true">
                ...
                <button type="button" class="input-button" id="add-subtask-btn" style="display: block" data-event-handle="true">
                    <svg width="14" height="14" id="plus-icon" alt="Plus Icon" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
